          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col items-start gap-3 sm:gap-4 w-full lg:max-w-[320px]">
              ...
              <a
                ...
                className="group mt-2 w-full max-w-[280px] bg-white/5 border border-white/10 rounded-2xl p-4 flex flex-col gap-3 hover:bg-white/10 hover:border-[#25D366]/40 transition-all duration-300 cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#25D366]/15 flex items-center justify-center shrink-0 group-hover:bg-[#25D366]/25 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-[10px]">Instant response</p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1 rounded-lg border border-white/10">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-2.5 h-2.5 text-[#F59E0B]">
                      <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
                    </svg>
                    <span className="text-[9px] font-black text-white/60 uppercase tracking-wider">Within 2 Hours</span>
                  </div>
                  <span className="text-[10px] font-bold text-[#25D366] group-hover:underline">Open →</span>
                </div>
              </a>
