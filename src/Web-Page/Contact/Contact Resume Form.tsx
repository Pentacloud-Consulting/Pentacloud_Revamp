...
import { MOCK_CAREER_APPLICATIONS } from "@/DashBoard/lib/mock-data";
          ...
          {formStatus === "success" ? (
            ...
            <>
              <div className="mb-4 sm:mb-6">
                <h3 className="text-xl sm:text-3xl font-nunito font-black text-[#0D1B2A] mb-1 sm:mb-2">Submit Your Resume</h3>
