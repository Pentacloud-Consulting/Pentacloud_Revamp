...
const DigitalFAQ = () => {
  ...
  return (
    <section className="py-8 sm:py-12 bg-[#E8F0F8] px-4 sm:px-6 md:px-12 rounded-[24px] sm:rounded-[48px]">
              ...
              .map(({ faq, originalIndex }) => (
                ...
                >
                  <button
                    ...
                    className="w-full px-4 py-4 sm:px-6 sm:py-6 flex items-center justify-between text-left group focus:outline-none focus-visible:ring-0 gap-3"
                  >
                    <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                       <div className={`w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-[#E8F0F8] shadow-[3px_3px_6px_rgba(163,185,210,0.3),-3px_-3px_6px_rgba(255,255,255,0.8)] flex items-center justify-center transition-all duration-500 shrink-0 ${activeIndex === originalIndex ? 'rotate-[15deg] shadow-inner scale-90' : 'group-hover:rotate-12'}`} style={{ color: faq.color }}>
                    ...
                    <div className={`w-7 h-7 sm:w-9 sm:h-9 rounded-full bg-[#E8F0F8] shadow-[3px_3px_6px_rgba(163,185,210,0.3),-3px_-3px_6px_rgba(255,255,255,0.8)] flex items-center justify-center text-[#1A7FD4] transition-all duration-500 shrink-0 ${activeIndex === originalIndex ? 'rotate-180 shadow-inner' : ''}`}>
                    ...
                    {activeIndex === originalIndex && (
                      ...
                      >
                        <div className="px-4 pb-5 pt-1 sm:px-6 sm:pb-8 sm:pt-2 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                            <div className="w-full sm:w-40 h-28 rounded-xl sm:rounded-2xl bg-[#E8F0F8] shadow-[inset_3px_3px_6px_rgba(163,185,210,0.25)] flex items-center justify-center overflow-hidden shrink-0">
                               <motion.img 
                           ...
                           <div className="flex-1 min-w-0">
                              ...
                              <Link href="/contact">
                                <motion.div
                                  whileHover={{ x: 5 }}
                                  className="mt-3 sm:mt-4 flex items-center gap-1.5 text-[#1A7FD4] font-nunito font-black text-xs uppercase tracking-wider"
                                >
