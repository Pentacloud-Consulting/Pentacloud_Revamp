...
const WebDevelopQuestions = () => {
  ...
  return (
    <section className="py-8 sm:py-12 bg-[#E8F0F8] px-4 sm:px-6 md:px-12">
              ...
              .map(({ faq, originalIndex }) => (
                ...
                >
                  <button
                    ...
                    className="w-full p-4 sm:px-6 sm:py-6 flex items-center justify-between text-left group focus:outline-none focus-visible:ring-0 gap-3"
                  >
                  ...
                  <AnimatePresence>
                    {activeIndex === originalIndex && (
                      ...
                      >
                        <div className="px-4 pb-6 pt-1 sm:px-6 sm:pb-8 sm:pt-2 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                           <div className="w-full sm:w-40 h-28 rounded-xl sm:rounded-2xl bg-[#E8F0F8] shadow-[inset_4px_4px_8px_rgba(163,185,210,0.3)] flex items-center justify-center overflow-hidden shrink-0 aspect-video sm:aspect-auto">
                              <motion.img 
